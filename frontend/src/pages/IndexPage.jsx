      ...
      <div className="mt-1 flex flex-col">
        <div className="hidden sm:block" >
          <div href="#" className="flex item-center inset-0">
            <img src="../assets/hero.jpg" alt="" className='w-full'/>
          </div>
        </div>
        ...
        {events.length > 0 && events.map((event) => {
          ...
          if (eventDate > currentDate || eventDate.toDateString() === currentDate.toDateString()){
            return (
              ...
              {event.image && (
                <img
                  src={`${import.meta.env.REACT_BACKEND}/api/${event.image}`}
                  alt={event.title}
                  width="300"
                  height="200"
                ...
                <img src="../assets/paduru.png" alt="" className='rounded-tl-[0.75rem] rounded-tr-[0.75rem] rounded-br-[0] rounded-bl-[0] object-fill aspect-16:9'/>
